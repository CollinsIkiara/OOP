...
catalogue = MediaCatalogue() # Create an instance/object of the MediaCatalogue class

# Add some movies and TV series to the catalogue, and print the catalogue. If any validation errors occur, catch them and print an error message. If a MediaError occurs, print the error message and the type of object that caused the error.
try:
